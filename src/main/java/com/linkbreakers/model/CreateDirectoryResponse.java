...
public class CreateDirectoryResponse {
  ...
  public CreateDirectoryResponse directory(@javax.annotation.Nullable Directory directory) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.directory, createDirectoryResponse.directory);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDirectoryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateDirectoryResponse is not found in the empty JSON string", CreateDirectoryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDirectoryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateDirectoryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
