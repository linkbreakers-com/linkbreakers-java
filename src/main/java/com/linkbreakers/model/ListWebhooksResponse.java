...
public class ListWebhooksResponse {
  ...
  public ListWebhooksResponse webhooks(@javax.annotation.Nullable List<Webhook> webhooks) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWebhooksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListWebhooksResponse is not found in the empty JSON string", ListWebhooksResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWebhooksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListWebhooksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
