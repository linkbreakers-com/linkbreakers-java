...
public class GetWebhookResponse {
  ...
  public GetWebhookResponse webhook(@javax.annotation.Nullable Webhook webhook) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWebhookResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetWebhookResponse is not found in the empty JSON string", GetWebhookResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWebhookResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetWebhookResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
