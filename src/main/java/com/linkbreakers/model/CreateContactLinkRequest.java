...
public class CreateContactLinkRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customDomainId, fallbackDestination, metadata, name, purpose, qrcodeDesignId, qrcodeTemplateId, shortlink, tags, vcardData, waitForQrcode);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customDomainId", "fallbackDestination", "metadata", "name", "purpose", "qrcodeDesignId", "qrcodeTemplateId", "shortlink", "tags", "vcardData", "waitForQrcode"));
