...
public class CreateContactLinkRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customDomainId, directoryId, fallbackDestination, id, metadata, name, purpose, qrcodeDesignId, qrcodeTemplateId, shortlink, tags, vcardData, waitForQrcode);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customDomainId", "directoryId", "fallbackDestination", "id", "metadata", "name", "purpose", "qrcodeDesignId", "qrcodeTemplateId", "shortlink", "tags", "vcardData", "waitForQrcode"));
