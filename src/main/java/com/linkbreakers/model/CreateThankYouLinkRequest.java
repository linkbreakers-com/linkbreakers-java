...
public class CreateThankYouLinkRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customDomainId, description, directoryId, id, metadata, name, purpose, qrcodeDesignId, qrcodeTemplateId, shortlink, tags, title, waitForQrcode);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customDomainId", "description", "directoryId", "id", "metadata", "name", "purpose", "qrcodeDesignId", "qrcodeTemplateId", "shortlink", "tags", "title", "waitForQrcode"));
