...
public class Link {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, customDomain, customDomainId, directoryId, entrypoint, eventCount, fallbackDestination, id, metadata, name, pageTheme, pageThemeId, purpose, qrcodeDesign, qrcodeDesignId, qrcodePendingUpdateSince, qrcodeSignedUrl, qrcodeTemplateId, shortlink, tags, updatedAt, workspaceId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("createdAt", "customDomain", "customDomainId", "directoryId", "entrypoint", "eventCount", "fallbackDestination", "id", "metadata", "name", "pageTheme", "pageThemeId", "purpose", "qrcodeDesign", "qrcodeDesignId", "qrcodePendingUpdateSince", "qrcodeSignedUrl", "qrcodeTemplateId", "shortlink", "tags", "updatedAt", "workspaceId"));
