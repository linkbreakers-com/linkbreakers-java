...
public class ListResponse {
  ...
  public ListResponse members(@javax.annotation.Nullable List<Member> members) {
    this.members = members;
    return this;
  }

  public ListResponse addMembersItem(Member membersItem) {
  ...
  public void setMembers(@javax.annotation.Nullable List<Member> members) {
    this.members = members;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.members, listResponse.members);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListResponse is not found in the empty JSON string", ListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
